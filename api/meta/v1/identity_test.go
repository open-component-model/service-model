...
func CheckVariantId(id *v1.ServiceVariantVersionIdentity, res string) {
	Expect(id.String()).To(Equal(res))

	var u v1.ServiceVariantVersionIdentity
...
var _ = Describe("Identity Test Environment", func() {
	It("service variant version", func() {
		CheckVariantId(v1.NewServiceVariantVersionIdentity(v1.NewServiceId("acme.org/test", "provider"), "v1",
			v1.Variant{"iaas": "AWS"}),
	...
	It("service variant version without version", func() {
		CheckVariantId(v1.NewServiceVariantVersionIdentity(v1.NewServiceId("acme.org/test", "provider"), "",
			v1.Variant{"iaas": "AWS"}),
